...
import { Heart, TrendingUp, TrendingDown, Activity, AlertTriangle, CheckCircle, Info } from 'lucide-react';
      ...
      <Card className="border-blue-200 bg-blue-50/50">
        ...
        <CardContent className="space-y-3">
          <div className="text-sm text-blue-800 space-y-2">
            <p>
              <strong>Hasil Prediksi:</strong> Model mengklasifikasikan pasien ke dalam 
